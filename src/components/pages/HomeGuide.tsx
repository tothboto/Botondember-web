 ...
 * A gomb felirata és a szöveg az Adminban szerkeszthető (Kezdőlap).
 */
    ...
    <>
      ...
      >
        <div className="flex items-start justify-between gap-4 border-b border-line p-5 sm:p-6">
          <h2 id="home-guide-title" lang="hu" className="font-display text-2xl font-black tracking-tight uppercase sm:text-3xl">
            {title}
          </h2>
          <button
            type="button"
        ...
        <div className="space-y-6 p-5 sm:p-6">
          <Markdown className="prose-lg">{text}</Markdown>
          {children}
        </div>
      </dialog>
    </>
